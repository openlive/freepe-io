...
[ -f "$ORIENTDB_HOME"/lib/orientdb-tools-2.2.3.jar ] || ORIENTDB_HOME=`cd "$PRGDIR/.." ; pwd`
...
exec "$JAVA" -client $JAVA_OPTS $ORIENTDB_SETTINGS $SSL_OPTS \
    -Dfile.encoding=utf-8 -Dorientdb.build.number="2.2.x@r2f229613abac00036c2fa1b59ab5d1e8a882d6de; 2016-06-20 06:46:10+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-tools-2.2.3.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \
